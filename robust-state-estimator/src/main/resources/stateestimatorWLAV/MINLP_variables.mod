...
var epi_resid_Pf{l in MEASURECC_Pf};
var epi_resid_Qf{l in MEASURECC_Qf};
var epi_resid_P{l in MEASURECC_P};
var epi_resid_Q{l in MEASURECC_Q};
var epi_resid_V{l in MEASURECC_V};
