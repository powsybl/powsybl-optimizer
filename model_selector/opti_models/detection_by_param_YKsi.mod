...
minimize problem_dbp:
  ...
  + sum{(qq,m,n) in BRANCHCC_PENALIZED} b_sigma8[qq,m,n] #* ((branch_Bex[1,qq,m,n] + 10e-5) / (sigma8[qq,m,n] + 10e-5))**2
  ...
  #+ sum{(qq,m,n) in BRANCHCC_PENALIZED} log(1 + (branch_Bex[1,qq,m,n] / (100 * sigma8[qq,m,n] + 10e-5)) ** 2)
