...
subject to penal_for_units_dbp{PROBLEM_DETECTION_PARAM, n in BUSCC_PV_UNITS}:                if (is_target_v_units == 0)     then s1[n] = 0;
subject to penal_for_svc_dbp{PROBLEM_DETECTION_PARAM, n in BUSCC_PV_SVC}:                    if (is_target_v_svc == 0)       then s1[n] = 0;
...
subject to ctr_sigma2_null_dbp{PROBLEM_DETECTION_PARAM, (qq,m,n) in BRANCHCC_PENALIZED}:     if (is_admittance_control == 0) then sigma2[qq,m,n] = 0;
subject to ctr_sigma3_null_dbp{PROBLEM_DETECTION_PARAM, (qq,m,n) in BRANCHCC_DEPH}:          if (is_phase_shif_control == 0) then sigma3[qq,m,n] = 0;
subject to ctr_sigma4_null_dbp{PROBLEM_DETECTION_PARAM, (qq,m,n) in BRANCHCC_PENALIZED}:     if (is_xi_control == 0)         then sigma4[qq,m,n] = 0;
subject to ctr_sigma5_null_dbp{PROBLEM_DETECTION_PARAM, (qq,m,n) in BRANCHCC_PENALIZED}:     if (is_g_shunt_1_control == 0)  then sigma5[qq,m,n] = 0;
subject to ctr_sigma6_null_dbp{PROBLEM_DETECTION_PARAM, (qq,m,n) in BRANCHCC_PENALIZED}:     if (is_b_shunt_1_control == 0)  then sigma6[qq,m,n] = 0;
subject to ctr_sigma7_null_dbp{PROBLEM_DETECTION_PARAM, (qq,m,n) in BRANCHCC_PENALIZED}:     if (is_g_shunt_2_control == 0)  then sigma7[qq,m,n] = 0;
subject to ctr_sigma8_null_dbp{PROBLEM_DETECTION_PARAM, (qq,m,n) in BRANCHCC_PENALIZED}:     if (is_b_shunt_2_control == 0)  then sigma8[qq,m,n] = 0;
...
subject to ctr_b_sigma4_pos_dbp{PROBLEM_DETECTION_PARAM, (qq,m,n) in BRANCHCC_PENALIZED}:   sigma4[qq,m,n] <= (Xi_p_sup - branch_angper[qq,m,n] + 0.001) * b_sigma4[qq,m,n];
...
subject to ctr_b_sigma2_neg_dbp{PROBLEM_DETECTION_PARAM, (qq,m,n) in BRANCHCC_PENALIZED}:   sigma2[qq,m,n] >= (Y_p_inf - branch_admi[qq,m,n]- 0.001) * b_sigma2[qq,m,n];
...
subject to ctr_b_sigma4_neg_dbp{PROBLEM_DETECTION_PARAM, (qq,m,n) in BRANCHCC_PENALIZED}:   sigma4[qq,m,n] >= (Xi_p_inf - branch_angper[qq,m,n]- 0.001) * b_sigma4[qq,m,n];
subject to ctr_b_sigma5_neg_dbp{PROBLEM_DETECTION_PARAM, (qq,m,n) in BRANCHCC_PENALIZED}:   sigma5[qq,m,n] >= (G1_p_inf - branch_Gor[1,qq,m,n]- 0.001) * b_sigma5[qq,m,n];
subject to ctr_b_sigma6_neg_dbp{PROBLEM_DETECTION_PARAM, (qq,m,n) in BRANCHCC_PENALIZED}:   sigma6[qq,m,n] >= (B1_p_inf - branch_Bor[1,qq,m,n]- 0.001) * b_sigma6[qq,m,n];
subject to ctr_b_sigma7_neg_dbp{PROBLEM_DETECTION_PARAM, (qq,m,n) in BRANCHCC_PENALIZED}:   sigma7[qq,m,n] >= (G2_p_inf - branch_Gex[1,qq,m,n]- 0.001) * b_sigma7[qq,m,n];
subject to ctr_b_sigma8_neg_dbp{PROBLEM_DETECTION_PARAM, (qq,m,n) in BRANCHCC_PENALIZED}:   sigma8[qq,m,n] >= (B2_p_inf - branch_Bex[1,qq,m,n]- 0.001) * b_sigma8[qq,m,n];
