...
| `penalty_transfo_ratio`                     | Weight of the transformer ratio term in the ACOPF objective (see [AC optimal powerflow](acOptimalPowerflow.md))                                                                        | $0$                | $\mathbb{R}^{+}$                              |
| `penalty_voltage_target_ratio`<br>⚠️ **Do not change** | Weight of the voltage target ratio term (Vmin/Vmax normalized target) in the ACOPF objective (see [AC optimal powerflow](acOptimalPowerflow.md))                                     | $0$                | $\mathbb{R}^{+}$                              |
| `penalty_voltage_target_data`<br>⚠️ **Do not change** | Weight of the voltage target data term (V0 input value targeting) in the ACOPF objective (see [AC optimal powerflow](acOptimalPowerflow.md))                                          | $0$                | $\mathbb{R}^{+}$                              |
