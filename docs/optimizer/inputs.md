...
| `ratio_voltage_target`                      | Ratio to calculate target V of buses for the voltage target ratio term of the ACOPF objective (see [AC optimal powerflow](acOptimalPowerflow.md))                                     | $0.5$              | $[0; 1]$                                      |
...
| `penalty_active_power`                      | Weight of the active power generation term in the ACOPF objective (see [AC optimal powerflow](acOptimalPowerflow.md))                                                                  | $1$                | $\mathbb{R}^{+}$                              |
...
| `penalty_voltage_target_ratio`<br>⚠️ **Do not change** | Weight of the voltage target ratio term (Vmin/Vmax normalized target) in the ACOPF objective (see [AC optimal powerflow](acOptimalPowerflow.md))                                     | $0.01$             | $\mathbb{R}^{+}$                              |
| `penalty_voltage_target_data`<br>⚠️ **Do not change** | Weight of the voltage target data term (V0 input value targeting) in the ACOPF objective (see [AC optimal powerflow](acOptimalPowerflow.md))                                          | $0.01$             | $\mathbb{R}^{+}$                              |
