...
These files are obtained by using the [V3 of the extended version of PowSyBl AMPL export](https://github.com/powsybl/powsybl-core/blob/main/ampl-converter/src/main/java/com/powsybl/ampl/converter/version/ExtendedAmplExporterV3.java), which is the default version.  
...
| `objective_choice`<br>⚠️ **Do not change** | Choice of the objective function for the ACOPF (see [AC optimal powerflow](acOptimalPowerflow.md))                                                                                     | $0$                | {0, 1, 2}                                     |
...
| `penalty_invest_rea_pos`                    | Weight of the positive reactive slack penalty term in the ACOPF objective (see [AC optimal powerflow](acOptimalPowerflow.md))                                                          | $10$               | $\mathbb{R}^{+}$                              |
| `penalty_invest_rea_neg`                    | Weight of the negative reactive slack penalty term in the ACOPF objective (see [AC optimal powerflow](acOptimalPowerflow.md))                                                          | $10$               | $\mathbb{R}^{+}$                              |
| `penalty_active_power`                      | Weight of the active power generation term in the ACOPF objective. If left unset, resolved at export to $1$ when `objective_choice` $=0$, and $0.01$ otherwise (see [AC optimal powerflow](acOptimalPowerflow.md)) | objective-dependent ($1$ or $0.01$) | $\mathbb{R}^{+}$                              |
| `penalty_units_reactive`                    | Weight of the reactive power of units term in the ACOPF objective (see [AC optimal powerflow](acOptimalPowerflow.md))                                                                  | $0.1$              | $\mathbb{R}^{+}$                              |
| `penalty_transfo_ratio`                     | Weight of the transformer ratio term in the ACOPF objective (see [AC optimal powerflow](acOptimalPowerflow.md))                                                                        | $0.1$              | $\mathbb{R}^{+}$                              |
| `penalty_voltage_target_ratio`<br>⚠️ **Do not change** | Weight of the voltage target ratio term (Vmin/Vmax normalized target) in the ACOPF objective. If left unset, resolved at export to $1$ when `objective_choice` $=1$, and $0.01$ otherwise (see [AC optimal powerflow](acOptimalPowerflow.md)) | objective-dependent ($1$ or $0.01$) | $\mathbb{R}^{+}$                              |
| `penalty_voltage_target_data`<br>⚠️ **Do not change** | Weight of the voltage target data term (V0 input value targeting) in the ACOPF objective. If left unset, resolved at export to $1$ when `objective_choice` $=2$, and $0.01$ otherwise (see [AC optimal powerflow](acOptimalPowerflow.md)) | objective-dependent ($1$ or $0.01$) | $\mathbb{R}^{+}$                              |
