...
You will have the running OpenReac folders next to your working
directory.
...
You can customize OpenReac parameters directly with the option
`--open-reac-params params.json`. Here are the specific mappings.
...
Here is a quick description for each objective and how to put them in
the json.
